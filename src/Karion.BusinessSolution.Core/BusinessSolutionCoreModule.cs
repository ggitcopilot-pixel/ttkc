...
using Karion.BusinessSolution.Authorization.Ldap;
...
using Karion.BusinessSolution.DashboardCustomization.Definitions;
using Karion.BusinessSolution.Debugging;
using Karion.BusinessSolution.DynamicEntityParameters;
using Karion.BusinessSolution.Features;
...
using Karion.BusinessSolution.Net.Emailing;
using Karion.BusinessSolution.Notifications;
using Karion.BusinessSolution.WebHooks;

namespace Karion.BusinessSolution
{
    [DependsOn(
        typeof(BusinessSolutionCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class BusinessSolutionCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            BusinessSolutionLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = BusinessSolutionConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, BusinessSolutionMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<BusinessSolutionSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(BusinessSolutionCoreModule).GetAssembly());
        }
