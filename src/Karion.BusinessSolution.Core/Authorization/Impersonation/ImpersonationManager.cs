...
namespace Karion.BusinessSolution.Authorization.Impersonation
{
    public class ImpersonationManager : BusinessSolutionDomainServiceBase, IImpersonationManager
    {
