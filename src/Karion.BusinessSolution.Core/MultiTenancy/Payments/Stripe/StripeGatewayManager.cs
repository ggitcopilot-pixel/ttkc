...
namespace Karion.BusinessSolution.MultiTenancy.Payments.Stripe
{
    public class StripeGatewayManager : BusinessSolutionServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "BusinessSolution";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + BusinessSolutionConsts.Currency;
        }
