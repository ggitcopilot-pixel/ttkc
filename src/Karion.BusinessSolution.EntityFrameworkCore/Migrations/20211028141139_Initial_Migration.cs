        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReturnValue = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ParameterName = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
                    InputType = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
                    Permission = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
                    TenantId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Discriminator = table.Column<string>(nullable: false).Annotation("MySql:CharSet", "utf8"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientName = table.Column<string>(maxLength: 128, nullable: true),
                    CreationTime = table.Column<DateTime>(nullable: false),
                    ExtensionData = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
                    ImpersonatorTenantId = table.Column<int>(nullable: true),
                    ImpersonatorUserId = table.Column<long>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(maxLength: 200, nullable: false).Annotation("MySql:CharSet", "utf8"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SignInToken = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
                    GoogleAuthenticatorKey = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    WebhookName = table.Column<string>(nullable: false).Annotation("MySql:CharSet", "utf8"),
                    Data = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
                    CreationTime = table.Column<DateTime>(nullable: false),
                    TenantId = table.Column<int>(nullable: true),
                    IsDeleted = table.Column<bool>(nullable: false),
                    DeletionTime = table.Column<DateTime>(nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatorUserId = table.Column<long>(nullable: true),
                    TenantId = table.Column<int>(nullable: true),
                    WebhookUri = table.Column<string>(nullable: false).Annotation("MySql:CharSet", "utf8"),
                    Secret = table.Column<string>(nullable: false).Annotation("MySql:CharSet", "utf8"),
                    IsActive = table.Column<bool>(nullable: false),
                    Webhooks = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
                    Headers = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FriendTenancyName = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    InvoiceNo = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
                    InvoiceDate = table.Column<DateTime>(nullable: false),
                    TenantLegalName = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
                    TenantAddress = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
                    TenantTaxNo = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Key = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
                    Value = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
                    IsDeleted = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Value = table.Column<string>(nullable: false).Annotation("MySql:CharSet", "utf8"),
                    TenantId = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    EntityFullName = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
                    DynamicParameterId = table.Column<int>(nullable: false),
                    TenantId = table.Column<int>(nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeleterUserId = table.Column<long>(nullable: true),
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    Description = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
                    ...
                    ExternalPaymentId = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
                    InvoiceNo = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
                    IsRecurring = table.Column<bool>(nullable: false),
                    SuccessUrl = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
                    ErrorUrl = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(nullable: true),
                    UserId = table.Column<long>(nullable: true),
                    Name = table.Column<string>(maxLength: 255, nullable: false).Annotation("MySql:CharSet", "utf8"),
                    Value = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClaimValue = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Response = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Value = table.Column<string>(nullable: false).Annotation("MySql:CharSet", "utf8"),
                    EntityId = table.Column<string>(nullable: true).Annotation("MySql:CharSet", "utf8"),
