...
namespace Karion.BusinessSolution.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = BusinessSolutionConsts.MultiTenancyEnabled ? null : (int?)1;
        ...
        public DefaultLanguagesCreator(BusinessSolutionDbContext context)
        {
            _context = context;
        }
