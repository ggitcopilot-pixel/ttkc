...
using Karion.BusinessSolution.EntityFrameworkCore.Repositories;

namespace Karion.BusinessSolution.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : BusinessSolutionRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<BusinessSolutionDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
