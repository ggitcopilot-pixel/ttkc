...
namespace Karion.BusinessSolution.Web.Public.Startup
{
    [DependsOn(
        typeof(BusinessSolutionWebCoreModule)
    )]
    public class BusinessSolutionWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public BusinessSolutionWebFrontEndModule(IWebHostEnvironment env, BusinessSolutionEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(BusinessSolutionWebFrontEndModule).GetAssembly());
        }
    }
}
