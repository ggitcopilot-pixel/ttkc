...
using Karion.BusinessSolution.Web.Public.Startup;
using Karion.BusinessSolution.Web.Session;

namespace Karion.BusinessSolution.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : BusinessSolutionViewComponent
    {
