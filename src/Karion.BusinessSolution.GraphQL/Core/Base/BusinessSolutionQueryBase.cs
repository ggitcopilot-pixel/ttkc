...
namespace Karion.BusinessSolution.Core.Base
{
    public abstract class BusinessSolutionQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected BusinessSolutionQueryBase(string fieldName,
