...
using Karion.BusinessSolution.Core.Base;
using Karion.BusinessSolution.Core.Extensions;
using Karion.BusinessSolution.Dto;
using Karion.BusinessSolution.Types;

namespace Karion.BusinessSolution.Queries
{
    public class OrganizationUnitQuery : BusinessSolutionQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
