...
using Karion.BusinessSolution.MultiTenancy.Payments.Paypal;
using Karion.BusinessSolution.MultiTenancy.Payments.PayPal;
using Karion.BusinessSolution.MultiTenancy.Payments.PayPal.Dto;

namespace Karion.BusinessSolution.MultiTenancy.Payments
{
    public class PayPalPaymentAppService : BusinessSolutionAppServiceBase, IPayPalPaymentAppService
    {
