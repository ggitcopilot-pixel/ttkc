...
using Karion.BusinessSolution.MultiTenancy.Payments.Stripe;
using Karion.BusinessSolution.MultiTenancy.Payments.Stripe.Dto;
using Stripe;
using Stripe.Checkout;

namespace Karion.BusinessSolution.MultiTenancy.Payments
{
    public class StripePaymentAppService : BusinessSolutionAppServiceBase, IStripePaymentAppService
    {
