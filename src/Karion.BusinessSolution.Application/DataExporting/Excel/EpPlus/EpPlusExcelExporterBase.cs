...
namespace Karion.BusinessSolution.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : BusinessSolutionServiceBase, ITransientDependency
    {
