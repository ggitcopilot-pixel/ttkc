...
namespace Karion.BusinessSolution.DataExporting.Excel.NPOI
{
    public abstract class NpoiExcelExporterBase : BusinessSolutionServiceBase, ITransientDependency
    {
