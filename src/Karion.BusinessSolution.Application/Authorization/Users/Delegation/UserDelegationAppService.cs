...
namespace Karion.BusinessSolution.Authorization.Users.Delegation
{
    [AbpAuthorize]
    public class UserDelegationAppService : BusinessSolutionAppServiceBase, IUserDelegationAppService
    {
