...
using Karion.BusinessSolution.Migrations.Seed.Host;
using Newtonsoft.Json;
using Newtonsoft.Json.Linq;

namespace Karion.BusinessSolution.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : BusinessSolutionAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<BusinessSolutionDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{BusinessSolutionConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{BusinessSolutionConsts.ConnectionStringName}", constring);
        }
