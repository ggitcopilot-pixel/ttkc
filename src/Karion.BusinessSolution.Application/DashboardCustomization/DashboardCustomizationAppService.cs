...
namespace Karion.BusinessSolution.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : BusinessSolutionAppServiceBase, IDashboardCustomizationAppService
    {
