...
using Karion.BusinessSolution.DemoUiComponents.Dto;

namespace Karion.BusinessSolution.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : BusinessSolutionAppServiceBase, IDemoUiComponentsAppService
    {
