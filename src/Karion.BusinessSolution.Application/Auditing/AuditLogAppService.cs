...
using Karion.BusinessSolution.Auditing.Exporting;
using Karion.BusinessSolution.Authorization;
using Karion.BusinessSolution.Authorization.Users;
using Karion.BusinessSolution.Dto;
using Karion.BusinessSolution.EntityHistory;
using EntityHistoryHelper = Karion.BusinessSolution.EntityHistory.EntityHistoryHelper;

namespace Karion.BusinessSolution.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : BusinessSolutionAppServiceBase, IAuditLogAppService
    {
