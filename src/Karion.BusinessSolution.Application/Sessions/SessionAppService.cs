...
using Karion.BusinessSolution.UiCustomization;
using Karion.BusinessSolution.Authorization.Delegation;

namespace Karion.BusinessSolution.Sessions
{
    public class SessionAppService : BusinessSolutionAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = BusinessSolutionConsts.Currency,
                    CurrencySign = BusinessSolutionConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = BusinessSolutionConsts.AllowTenantsToChangeEmailSettings,
