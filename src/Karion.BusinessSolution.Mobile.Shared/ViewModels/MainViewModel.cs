...
using MvvmHelpers;
using Karion.BusinessSolution.Authorization.Users.Profile;
using Karion.BusinessSolution.Authorization.Users.Profile.Dto;
using Karion.BusinessSolution.Commands;
using Karion.BusinessSolution.Core.Threading;
using Karion.BusinessSolution.Models.NavigationMenu;
using Karion.BusinessSolution.Services.Navigation;
using Karion.BusinessSolution.ViewModels.Base;
using Plugin.Media;
...
using Karion.BusinessSolution.ApiClient;
using Karion.BusinessSolution.Controls;
using Karion.BusinessSolution.Dto;
using Karion.BusinessSolution.Extensions;
using Karion.BusinessSolution.Localization;
using Karion.BusinessSolution.UI;
using Karion.BusinessSolution.UI.Assets;
using Karion.BusinessSolution.Views;
using DependencyResolver = Karion.BusinessSolution.Core.Dependency.DependencyResolver;

namespace Karion.BusinessSolution.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "BusinessSolution";
