...
namespace Karion.BusinessSolution.Web.Security.Recaptcha
{
    public class RecaptchaValidator : BusinessSolutionServiceBase, IRecaptchaValidator, ITransientDependency
    {
