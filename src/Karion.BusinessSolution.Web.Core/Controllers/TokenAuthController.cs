...
using Karion.BusinessSolution.Web.Models.TokenAuth;
...
namespace Karion.BusinessSolution.Web.Controllers
{
    ...
    public class TokenAuthController : BusinessSolutionControllerBase
    {
        ...
        public class TokenRefreshJson
        {
            public string RefreshToken { get; set; }
        }
        [HttpPost]
        public async Task<RefreshTokenResult> RefreshTokenJson([FromBody] TokenRefreshJson input)
        {
