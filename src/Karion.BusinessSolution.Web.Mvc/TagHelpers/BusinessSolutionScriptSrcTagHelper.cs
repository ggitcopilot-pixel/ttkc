...
namespace Karion.BusinessSolution.Web.TagHelpers
{
    [HtmlTargetElement("script", Attributes = AbpSrcAttributeName)]
    public class BusinessSolutionScriptSrcTagHelper : TagHelper
    {
        ...
        public BusinessSolutionScriptSrcTagHelper(IWebHostEnvironment hostingEnvironment, IHttpContextAccessor httpContextAccessor)
        {
