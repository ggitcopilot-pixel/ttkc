(function ($) {
    app.modals.CapNhatAnhBacSiModal = function () {
        var _modalManager;
        var $jcropApi = null;
        ...
        this.save = function () {
            ...
            _bacSiChuyenKhoasService.capNhatAnhBacSi({
                ...
                thongTinBacSiMoRongId: $("#thongTinBacSiMoRongId").val()
            }).done(function () {
                $jcropApi.destroy();
                $jcropApi = null;
                $('.header-profile-picture').attr('src', app.getUserProfilePicturePath());
                _modalManager.close();
                abp.event.trigger('LoadLaiTrang');
            });
        };
    };
})(jQuery);