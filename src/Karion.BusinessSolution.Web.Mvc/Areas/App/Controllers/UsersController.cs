...
using Karion.BusinessSolution.Authorization.Permissions;
...
using Karion.BusinessSolution.Web.Areas.App.Models.Roles;
using Karion.BusinessSolution.Web.Areas.App.Models.Users;
...
namespace Karion.BusinessSolution.Web.Areas.App.Controllers
{
    ...
    public class UsersController : BusinessSolutionControllerBase
    {
