...
using Karion.BusinessSolution.Web.Areas.App.Models.Languages;
...
namespace Karion.BusinessSolution.Web.Areas.App.Controllers
{
    ...
    public class LanguagesController : BusinessSolutionControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = BusinessSolutionConsts.LocalizationSourceName;
            }
