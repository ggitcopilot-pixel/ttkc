...
using Karion.BusinessSolution.Web.Areas.App.Models.EntityDynamicParameterValues;
...
namespace Karion.BusinessSolution.Web.Areas.App.Controllers
{
    ...
    public class EntityDynamicParameterValueController : BusinessSolutionControllerBase
    {
