...
namespace Karion.BusinessSolution.Web.Areas.App.Views.Shared.Components.AppDefaultBrand
{
    public class AppDefaultBrandViewComponent : BusinessSolutionViewComponent
    {
