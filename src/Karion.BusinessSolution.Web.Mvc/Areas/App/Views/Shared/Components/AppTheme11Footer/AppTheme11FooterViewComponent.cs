...
namespace Karion.BusinessSolution.Web.Areas.App.Views.Shared.Components.AppTheme11Footer
{
    public class AppTheme11FooterViewComponent : BusinessSolutionViewComponent
    {
