...
namespace Karion.BusinessSolution.Web.Areas.App.Views.Shared.Components.AppTheme4Footer
{
    public class AppTheme4FooterViewComponent : BusinessSolutionViewComponent
    {
