...
namespace Karion.BusinessSolution.Web.Startup
{
    ...
    public class BusinessSolutionWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public BusinessSolutionWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(BusinessSolutionWebHostModule).GetAssembly());
        }
