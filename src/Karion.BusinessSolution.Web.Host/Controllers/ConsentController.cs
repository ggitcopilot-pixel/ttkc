...
using Karion.BusinessSolution.Web.Models.Consent;

namespace Karion.BusinessSolution.Web.Host.Controllers
{
    public class ConsentController : BusinessSolutionControllerBase
    {
